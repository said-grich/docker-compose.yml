...
class CreateUsers extends Component
{
    ...
    public function render()
    {
        ...
        return view('livewire.Parametrage-utilisateurs.create-users', ['list_roles' => $list_roles, 'list_permissions' => $list_permissions, 'da_permissions' => $da_permissions, 'dv_permissions' => $dv_permissions, 'compta_permissions' => $compta_permissions, 'user_permissions' => $user_permissions, 'list_sites' => $list_sites, 'list_depots' => $list_depots, 'list_depots_autorises' => $list_depots_autorises]);
    }
}
