...
class EditUser extends Component
{
    ...
    public function render()
    {
       ...
       $da = DB::table('permissions')
        ...
        return view('livewire.Parametrage-utilisateurs.edit-user',['list_roles'=>$list_roles,'da_permissions' =>$da_permissions, 'dv_permissions' => $dv_permissions,'compta_permissions'=>$compta_permissions,'user_permissions'=>$user_permissions, 'list_sites' => $list_sites, 'list_depots' => $list_depots, 'list_depots_autorises' => $list_depots_autorises]);
    }
}
