...
class CreateArticle extends Component
{
    ...
    public function render()
    {
        ...
        return view('livewire.paramétrage.create-article', [ 'list_fournisseurs' => $list_fournisseurs,'list_unites' => $list_unites,'list_familles' => $list_famille, 'list_depots' => $list_depots, 'list_sous_familles' => $list_sous_familles ]);
    }
}
