...
class ListFournisseurs extends Component
{
    ...
    public function render()
    {
        ...
        return view('livewire.paramétrage.list-fournisseurs',[
            'fournisseur'=> $fournisseur
        ]);
        /*$situationFourniseur = BonAchat::where('fournisseur_id', '1')->get();
        $list = Fournisseur::all()->sortByDesc('created_at');
        return view('livewire.paramétrage.list-fournisseurs', [ 'list' => $list, 'situationFourniseur'=> $situationFourniseur ]);*/
    }
