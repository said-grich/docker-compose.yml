...
use App\Http\Livewire\Gallerie;
 ...
 */
    ...
    public function setPhotos($photo_tmp)
    {
        $this->photo_principale = $photo_tmp;
    }
    public function createProduit()
    {
        ...
        DB::transaction(function () {
            ...
            $item->photo_principale = $this->photo_principale;
