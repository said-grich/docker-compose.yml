...
class CreateFournisseur extends Component
{
    ...
    public function createFournisseur()
    {
        ...
        $this->reset(['name', 'adresse','code_comptable','code_postal','ville','pays','canton','phone','telephone_fixe','fax','email','modePaiementId','siteId']);
    ...
    public function render()
    {
        ...
        return view('livewire.Parametrage.create-fournisseur', [ 'list_paiements' => $list_paiements ]);
    }
}
