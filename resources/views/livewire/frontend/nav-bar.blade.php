			...
			<div class="row">          
				...
				<div class="col-xs-12 col-sm-6 col-md-6 col-lg-4 d-none-m">
					...
					<ul class="links">
						...
						<li><a rel="nofollow" href="https://pinterest.com/pin/create/button/?url=http://flouka.ma/&amp;media=http://flouka.ma/logo.png&amp;description=Espace+B%C3%A9b%C3%A9+Maroc+%26%238211%3B+Votre+Sp%C3%A9cialiste+de+la+pu%C3%A9riculture" target="_blank" title="Pinterest"><i class="fab fa-pinterest-p"></i></a></li>
	...
	<header class="cd-main-header">
		...
		<nav class="cd-nav">
			<ul id="cd-primary-nav" class="cd-primary-nav is-fixed">
				...
				@guest
				<li>
					<a href="{{ route('connexion') }}"><button type="button" class="btn btn-rounded btn-inline btn-primary-outline">Connexion</button></a>
					<a href="{{ route('sinscrire') }}"><button type="button" class="btn btn-rounded btn-inline btn-primary">S'inscrire</button></a>
				</li>
				@endguest
			</ul> <!-- primary-nav -->
		</nav> <!-- cd-nav -->
		...
		<ul class="cd-header-buttons">
			...
			<li><a class="cd-cart-trigger" href="{{ route('panier') }}"><i class="fa fa-shopping-cart"></i>({{ $cartTotal }})</a></li>
