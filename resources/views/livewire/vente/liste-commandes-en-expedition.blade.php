    ...
    <div>
        <div class="table-responsive">
            <div class="d-flex flex-row-reverse">
                    ...
                    @foreach ($items as $item)
                        <tr @if($loop->even)class="bg-grey"@endif>
                            ...
                            <td class="pr-0 text-right">
                                <a href="#" wire:click="livree('{{ $item->ref }}')" class="btn btn-light-primary font-weight-bold mr-2">Livrée</a>

                                <a href="#" wire:click="show('{{$item->ref}}')" class="btn btn-icon btn-light btn-hover-primary btn-sm mx-3" data-toggle="modal" data-target="#show-en-expedition">
                ...
                {{-- Show Modal --}}
                <div wire:ignore.self class="modal fade" id="show-en-expedition" data-backdrop="static" tabindex="-1" role="dialog" aria-labelledby="show-en-expedition" aria-hidden="true">
