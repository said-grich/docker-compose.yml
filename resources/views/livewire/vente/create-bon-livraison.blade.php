@section('title', 'Création bon de livraison')
@section('header_title', 'Création bon de livraison')
                        ...
                        <ul class="nav nav-tabs nav-bold nav-tabs-line" style="margin-left: 30px;">
                            <li class="nav-item">
                                <a class="nav-link active" data-toggle="tab" href="#lient_tab_1">
                                    ...
                                    <span class="nav-text">Nouveau bon de livraison</span>
                                </a>
                            </li>
                            <li class="nav-item">
                                <a class="nav-link" data-toggle="tab" href="#lient_tab_2">
                                    <span class="nav-icon"><i class="flaticon2-drop"></i></span>
                                    <span class="nav-text">Liste bon de livraison</span>
                                </a>
                            </li>
                        </ul>
                    </div>
                    ...
                    <div class="card-body" style="margin-top: 25px;">
                        <div class="tab-content">
                            <div class="tab-pane fade show active" id="lient_tab_1" role="tabpanel" aria-labelledby="lient_tab_1">
                                <div>
                                    <form wire:submit.prevent="saveBonLivraison" class="form">
                                        <div class="row">
                                            <div class="col">
                                            ...
                                            <div class="col">
                                                <div class="input-group">
                                                    ...
                                                    <label>{{ __('Bon livraison Ref.') }}</label>
                                                </div>
                                                @error('ref')
                                                    <span class="form-text text-danger">{{ $message }}</span>
                                                @enderror
                                            ...
                                            <table class="table table-vertical-center table-bordered">
                                                <thead >
                                                    <tr class="text-left">
                                                        ...
                                                        <th class="">{{ __('Prix + charges directes') }}</th>

                                                        <th class="">{{ __('Prix + charges indirectes') }}</th>
                            ...
                            <div class="tab-pane fade " id="lient_tab_2" role="tabpanel" aria-labelledby="lient_tab_2">
                                @livewire('vente.liste-bon-livraison')
                            </div>
                        </div>
        ...
        <div class="min-w-7xl mx-auto py-10 sm:px-6 lg:px-8">
            ...
            <form wire:submit.prevent="saveBonLivraison">
                ...
                <div class="grid grid-cols-6 gap-4 p-4 mb-8">
                    ...
                    <label class="block">
                        <span class="text-gray-700">Bon livraison Ref.</span>
