@section('title', 'Création sites')
@section('header_title', 'Création sites')
            ...
            <div class="col-xl-12">
                ...
                <div class="card card-custom card-stretch gutter-b">
                    ...
                    <div class="card-body">
                            ...
                            <div class="modal-dialog modal-lg modal-dialog-centered" role="document">
                                <div class="modal-content">
                                    <div class="modal-header">
                                        <h5 class="modal-title" id="exampleModalLabel">{{ __('Nouveau site') }}</h5>
                                        <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                                            <i aria-hidden="true" class="ki ki-close"></i>
                                        </button>
                                    </div>
                                    <div class="modal-body">
                                        <form id="site-form" class="form" wire:submit.prevent="createSite">
                        ...
                        <!--Table-->
                        @livewire('paramétrage.liste-site')
                    </div>
                </div>
                <!--end::Card-->
            </div>
