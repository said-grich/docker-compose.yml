<div class="table-responsive">
    ...
    <table class="table table-head-custom table-vertical-center" id="kt_advance_table_widget_4">
        <thead>
            <tr class="text-left">
                ...
                <th class="pl-0" wire:click="sortBy('contact')" style="cursor: pointer;">Contact @include('layouts.partials._sort-icon',['field'=>'contact'])</th>
    ...
    <div wire:ignore.self class="modal fade" id="edit1" tabindex="-1" role="dialog" aria-labelledby="edit" aria-hidden="true">
                ...
                <div class="modal-body">
                    <form id="edit-form" class="form row">
                        ...
                        <div class="form-group col-md-12">
                            <div class="input-group input-group-prepend">
                                <div class="input-group-prepend"><span class="input-group-text"><i class="fa fa-user-tag icon-lg"></i></span></div>
                                <input type="text" class="form-control" placeholder=" " wire:model.defer="tel"/>
                                <label>{{ __('Tel') }}</label>
                            </div>
                            @error('tel')
                                <span class="form-text text-danger">{{ $message }}</span>
                    ...
                    <div class="modal-footer">
                        <button type="button" class="btn btn-light-primary font-weight-bold" data-dismiss="modal">{{ __('Fermer') }}</button>
                        <button type="submit" wire:click="editFournisseur" class="btn btn-primary font-weight-bold" form="edit-form" >{{ __('Enregistrer') }}</button>
                    </div>
                </div>
