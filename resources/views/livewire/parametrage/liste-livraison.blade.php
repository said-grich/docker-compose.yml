    ...
    <table class="table table-head-custom table-vertical-center" id="kt_advance_table_widget_4">
        <thead>
            <tr class="text-left">
                ...
                <th class="pl-0" wire:click="sortBy('seuil_commande')" style="cursor: pointer;">Seuil commande @include('layouts.partials._sort-icon',['field'=>'seuil_commande'])</th>
                <th class="pl-0" wire:click="sortBy('frais_livraison')" style="cursor: pointer;">Frais livraison @include('layouts.partials._sort-icon',['field'=>'frais_livraison'])</th>
                <th class="pl-0" wire:click="sortBy('seuil_livraison_gratuite')" style="cursor: pointer;">Seuil livraison gratuite @include('layouts.partials._sort-icon',['field'=>'seuil_livraison_gratuite'])</th>
                <th class="pl-0" wire:click="sortBy('jours_livraison')" style="cursor: pointer;">Jours livraison @include('layouts.partials._sort-icon',['field'=>'jours_livraison'])</th>
                <th class="pl-0" wire:click="sortBy('heure')" style="cursor: pointer;">Heure @include('layouts.partials._sort-icon',['field'=>'heure'])</th>
        ...
        <tbody>
            @foreach ($items as $item)
                    ...
                    <td class="pl-0">
                        <a href="#" class="text-dark-75 font-weight-bolder text-hover-primary font-size-lg">{{ $item->seuil_commande }}</a>
                    </td>
                    <td class="pl-0">
                        <a href="#" class="text-dark-75 font-weight-bolder text-hover-primary font-size-lg">{{ $item->frais_livraison }}</a>
                    </td>
                    <td class="pl-0">
                        <a href="#" class="text-dark-75 font-weight-bolder text-hover-primary font-size-lg">{{ $item->seuil_livraison_gratuite }}</a>
                    </td>
                    <td class="pl-0">
                    ...
                    <td class="pl-0">
                        <a href="#" class="text-dark-75 font-weight-bolder text-hover-primary font-size-lg">{{ $item->heure }}</a>
                    </td>
                    <td class="pl-0">
                        ...
                        <form id="edit-form" class="form row">
                            ...
                            {{-- <div class="form-group col-md-6">
                                <div class="input-group input-group-prepend">
                                    ...
                                    <label>{{ __('jours_livraison') }}</label>
                                </div>
                            ...
                            <div class="form-group col-md-6">
                                <div class="input-group input-group-prepend">
                                    ...
                                    <label>{{ __('frais_livraison') }}</label>
                                </div>
