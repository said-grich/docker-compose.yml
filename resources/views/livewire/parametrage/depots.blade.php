            ...
            <div class="col-xl-12">
                ...
                <div class="card card-custom card-stretch gutter-b">
                    ...
                    <div class="card-body">
                        ...
                        <button class="btn btn-primary font-weight-bold btn-pill" data-toggle="modal" data-target="#depot">
                            <i class="flaticon-plus"></i> {{ __('Ajouter Dépôt') }}
                        </button>
                        <!--Modal-->
                        <div wire:ignore.self class="modal fade" id="depot" data-backdrop="static" tabindex="-1" role="dialog" aria-labelledby="depot" aria-hidden="true">
                            <div class="modal-dialog modal-lg modal-dialog-centered" role="document">
                                <div class="modal-content">
                                    <div class="modal-header">
                                        <h5 class="modal-title">{{ __('Nouveau Dépôt') }}</h5>
                                        <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                                            <i aria-hidden="true" class="ki ki-close"></i>
                                        </button>
                                    </div>
                                    <div class="modal-body">
                                        <form id="depot-form" class="form" wire:submit.prevent="createDepot">
                                    ...
                                    <div class="modal-footer">
                                        ...
                                        <button type="submit" class="btn btn-primary font-weight-bold" form="depot-form">{{ __('Enregistrer') }}</button>
                                    </div>
                                </div>
                            </div>
                        </div>
