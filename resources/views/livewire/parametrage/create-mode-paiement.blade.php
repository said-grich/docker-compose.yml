@section('title', 'Création mode de paiement')
@section('header_title', 'Création mode de paiement')
            ...
            <div class="col-xl-12">
                ...
                <div class="card card-custom card-stretch gutter-b">
                    <div class="card-header">
                        <h3 class="card-title">{{ __('Liste mode de paiement') }}</h3>
                    </div>
                    <div class="card-body">
                        <!--Button trigger modal-->
                        <button class="btn btn-primary font-weight-bold btn-pill" data-toggle="modal" data-target="#staticBackdrop">
                            <i class="flaticon-plus"></i> {{ __('Ajouter un nouveau mode de paiement') }}
                        </button>
                        <!--Modal-->
                            ...
                            <div class="modal-dialog modal-lg modal-dialog-centered" role="document">
                                <div class="modal-content">
                                    <div class="modal-header">
                                        <h5 class="modal-title" id="exampleModalLabel">{{ __('Nouveau mode de paiement') }}</h5>
                                        ...
                                        <form id="Mode-paiement-form" class="form" wire:submit.prevent="createModePaiement">
                                            ...
                                            <div class="form-group">
                                                <div class="input-group input-group-prepend">
                                                    ...
                                                    <input type="text" class="form-control" placeholder=" " wire:model.defer="modalites_paiement"/>
                                                    <label>{{ __('Modalités de paiement') }}</label>
                                                </div>
                        ...
                        <!--Table-->
                        @livewire('paramétrage.liste-mode-paiement')
                    </div>
                </div>
                <!--end::Card-->
            </div>
