        ...
        <tbody>
            ...
            <tr @if($loop->even)class="bg-grey"@endif>
                    ...
                    <td class="pr-0 text-right">
                        ...
                        <a href="#" class="btn btn-icon btn-light btn-hover-primary btn-sm" wire:click="deleteQualite('{{ $item->id }}')">
                            <span class="svg-icon svg-icon-md svg-icon-primary">
                                {{--begin::Svg Icon--}}
                                <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="24px" height="24px" viewBox="0 0 24 24" version="1.1">
                                    <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <div class="modal-footer">
                        ...
                        <button type="submit" wire:click="editQualite" class="btn btn-primary font-weight-bold" form="edit-form" >{{ __('Enregistrer') }}</button>
                    </div>
                </div>
