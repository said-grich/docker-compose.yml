            ...
            <div class="modal-dialog modal-dialog-centered modal-xl" role="document">
                <div class="modal-content">
                    <div class="modal-header">
                        <h5 class="modal-title" id="exampleModalLabel">{{ __('Modification Depot') }}</h5>
                    ...
                    <div class="modal-body">
                        <form id="edit-form" class="form">
                            <div class="form-group">
                                <div class="input-group input-group-prepend">
                                    ...
                                    <input type="hidden" class="form-control" placeholder=" " wire:model.defer="depot_id"/>
                        ...
                        <div class="modal-footer">
                            ...
                            <button type="submit" wire:click="editModeDepot" class="btn btn-primary font-weight-bold" form="edit-form" >{{ __('Enregistrer') }}</button>
                        </div>
                    </div>
