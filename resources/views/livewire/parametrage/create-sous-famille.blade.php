@section('title', 'Création  Sous-familles')
@section('header_title', 'Création  Sous-familles')
                ...
                <div class="col-xl-12">
                    ...
                    <div class="card card-custom card-stretch gutter-b">
                        <div class="card-header">
                            <h3 class="card-title">{{ __('Liste sous-famille') }}</h3>
                        </div>
                        <div class="card-body">
                            <!--Button trigger modal-->
                            <button class="btn btn-primary font-weight-bold btn-pill" data-toggle="modal" data-target="#staticBackdrop">
                                <i class="flaticon-plus"></i> {{ __('Ajouter une nouvelle sous-famille') }}
                            </button>
                            <!--Modal-->
                                ...
                                <div class="modal-dialog modal-lg modal-dialog-centered" role="document">
                                    <div class="modal-content">
                                        <div class="modal-header">
                                            <h5 class="modal-title" id="exampleModalLabel">{{ __('Nouvelle sous-famille') }}</h5>
                                            <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                                                <i aria-hidden="true" class="ki ki-close"></i>
                                            </button>
                                        </div>
                                        <div class="modal-body">
                                            <form id="sous-famille-form" class="form" wire:submit.prevent="createSousFamille">
                                        ...
                                        <div class="modal-footer">
                                            ...
                                            <button type="submit" class="btn btn-primary font-weight-bold" form="sous-famille-form">{{ __('Enregistrer') }}</button>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            <!--Table-->
                            @livewire('paramétrage.liste-sous-famille')
                        </div>
                    </div>
                    <!--end::Card-->
                </div>
