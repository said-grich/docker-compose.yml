...
<div class="min-w-7xl mx-auto py-10 sm:px-6 lg:px-8">
    ...
    <x-jet-form-section submit="editFamille">
        <x-slot name="title">
            {{ __('Modification famille') }}
        </x-slot>
        ...
        <x-slot name="form">
            ...
            <div class="col-span-6 sm:col-span-4">
                <x-jet-label for="name" value="{{ __('Code famille') }}" />
            ...
            <div class="col-span-6 sm:col-span-4">
                ...
                <x-jet-input id="famille" type="text" class="mt-1 block w-full" wire:model.defer="famille" autocomplete="famille" />
