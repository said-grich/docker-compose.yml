...
@section('header_title', 'modification d\'un règlement fournisseur')
    <div x-show="openTab === 1">
        <div class="min-w-7xl mx-auto py-10 sm:px-6 lg:px-8">
            ...
            <x-jet-form-section submit="editReglementFournisseur" style="padding-bottom: 45px;">
                <x-slot name="title">
                ...
                {{-- <div x-data="{ open: false }" class="col-span-6 sm:col-span-4">
                    <div class="col-span-6 sm:col-span-4">
                            <label class="block">
                                ...
                                <select  wire:model.defer="modePaiementId" class="block w-full px-3 py-2 mt-1 bg-white border border-gray-300 rounded-md i-sm focus:outline-none focus:ring-indigo-500 focus:border-indigo-500 sm:text-sm">
                    ...
                    <div x-show="open === 3 || open === 2" class="col-span-6 sm:col-span-4">
                        <label class="block">
                            ...
                            <input wire:model.defer="dateEcheance"  type="date" class="block w-full mt-1 form-input">
                        </label>
                    </div>
                    ...
                    <div x-show="open === 2 " class="col-span-6 sm:col-span-4">
                        <label class="block">
                            ...
                            <input type="date" wire:model.defer="datemiseBanque" class="block w-full mt-1 form-input"  >
                        </label>
                    </div>
                    <div x-show="open === 1" class="col-span-6 sm:col-span-4">
                        <label class="block">
                            <span class="text-gray-700">Date encaissement</span>
                            <input wire:model.defer="dateEncaissement"  type="date" class="block w-full mt-1 form-input" >
                        </label>
                    </div>
                    <div x-show="open === 1" class="col-span-6 sm:col-span-4">
                        <label class="block">
                            <span class="text-gray-700">Caisse</span>
                            <select  wire:model.defer="caisse_id" class="block w-full px-3 py-2 mt-1 bg-white border border-gray-300 rounded-md i-sm focus:outline-none focus:ring-indigo-500 focus:border-indigo-500 sm:text-sm">
                                <option value="0"> Choisir </option>
                    ...
                    <div x-show="open === 3 || open === 2"  class="col-span-6 sm:col-span-4">
                        <div x-data="{ open: false }" class="col-span-6 sm:col-span-4">
                            <div class="col-span-6 sm:col-span-4">
                                ...
                                <select id="ValidationPaiement" wire:model.defer="ValidationPaiement" autocomplete="ValidationPaiement"  class="mt-1 block w-full py-2 px-3 border border-gray-300 bg-white rounded-md shadow-sm focus:outline-none focus:ring-indigo-500 focus:border-indigo-500 sm:text-sm" >
                            ...
                            <div x-show="open === 3" class="col-span-6 sm:col-span-4">
                                <label class="block">
                                    ...
                                    <input wire:model.defer="dateImpaye" type="date" class="block w-full mt-1 form-input" >
                                </label>
                            </div>
                        </div>
                    </div>
                ...
                <div x-data="" class="col-span-6 sm:col-span-4">
                    <div class="col-span-6 sm:col-span-4">
                            <label class="block">
                                <span class="text-gray-700">Mode de paiement</span>
                                <select  wire:model.defer="modePaiementId" class="block w-full px-3 py-2 mt-1 bg-white border border-gray-300 rounded-md i-sm focus:outline-none focus:ring-indigo-500 focus:border-indigo-500 sm:text-sm" disabled>
                                    <option @click="open = 0" value="0" > Choisir un Mode</option>
                                    @foreach ($list_paiements as $item)
                                        <option @click="open = {{ $item->id }}" value="{{ $item->id }}">{{ $item->name }} </option>
                                    @endforeach
                ...
                <div x-data="{'showVirement': @entangle('showVirement')}">
                    <div x-show="showVirement"  class="col-span-6 sm:col-span-4">
                        <div class="col-span-6 sm:col-span-4">
                            <x-jet-label for="ref" value="{{ __('Réf') }}" />
                            <x-jet-input id="ref" type="text" class="mt-1 block w-full" wire:model.defer="ref" autocomplete="ref" />
                            <x-jet-input-error for="ref" class="mt-2" />
                ...
                <div x-data="{'showCheque': @entangle('showCheque')}">
                    <div x-show="showCheque" class="col-span-6 sm:col-span-4">
                        <div class="col-span-6 sm:col-span-4">
                            <x-jet-label for="ref" value="{{ __('Réf') }}" />
                            <x-jet-input id="ref" type="text" class="mt-1 block w-full" wire:model.defer="ref" autocomplete="ref" />
                            <x-jet-input-error for="ref" class="mt-2" />
                        ...
                        <div class="col-span-6 sm:col-span-4">
                            <div x-data="" class="col-span-6 sm:col-span-4">
                                ...
                                <div x-data="{'showDateEncaissement': @entangle('showDateEncaissement')}">
                                    <div x-show="showDateEncaissement" class="col-span-6 sm:col-span-4">
                                        <label class="block">
                                            <span class="text-gray-700">Date encaissement</span>
                                            <input wire:model.defer="dateEncaissement"  type="date" class="block w-full mt-1 form-input" >
                                        </label>
                                ...
                                <div x-data="{'showDateImpaye': @entangle('showDateImpaye')}">
                                    <div x-show="showDateImpaye" class="col-span-6 sm:col-span-4">
                                        <label class="block">
                                            <span class="text-gray-700">Date Impayé</span>
                                            <input wire:model.defer="dateImpaye" type="date" class="block w-full mt-1 form-input" >
                                        </label>
                ...
                <div x-data="{'showEspeces': @entangle('showEspeces')}">
                    <div x-show="showEspeces" class="col-span-6 sm:col-span-4">
                        <label class="block">
                            <span class="text-gray-700">Date encaissement</span>
                            <input wire:model.defer="dateEncaissement"  type="date" class="block w-full mt-1 form-input" >
                        </label>
